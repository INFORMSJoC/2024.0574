...
void get_paths(std::string &fname_graver, std::string &fname_graver_sr, std::string &fname_cij, std::string &fname_tij, std::string &fname_ini_sol, std::string &fname_ini_fr, std::string &fname_lanes, std::string &path_dir_name){
     fname_graver = path_dir_name + "/fsol_graver_r_fr.npy";
...
void do_main_FR(std::string path_dir_name, std::string nodes_fname_csv, std::string edges_fname_csv, int do_tol){
...
;   */
    ...
    */   
    ...
    do_sr(nedges_undir, ngraver_sr, nedges_graver_sr_ij, graver_sr_ij_nonzero_ids, graver_sr_ij, fwalk_sol, cur_sol, cur_time, cur_time_evac, cur_time_edges, cur_time_evac_edges, cur_fr_bool, edge_sol_lookup, edge_sol_lookup_evac, cur_cij_undir, tij_undir, fwalk_time_edges, fwalk_time_evac_edges, alpha, beta, t1, n_counter, SR_counter_aug, do_tol);
...
int main(int argc, char **argv){
    ...
    do_tol = std::stoi(argv[4]);
    do_main_FR(path_dir_name, nodes_fname_csv, edges_fname_csv, do_tol);
}

// ./main_FR_Tgraph_instances data/Q-HOPE_output/Tgraph/graph_10000SA1__1 data/instances/Tgraph_noNorm/nodes_1.csv data/instances/Tgraph_noNorm/edges_1.csv 0
